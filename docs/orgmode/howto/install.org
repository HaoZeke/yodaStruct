...
~fennel.dofile~ on that file; see [[file:fennel.org][Fennel]].
...
- [[file:../quickstart.org][Quickstart]] - First ~require~
- [[file:../tutorials/read-and-classify.org][Read a dump and classify]] - CHILL+ and cages
- [[file:embed-lua.org][Embed in a Lua host]] - Load the ~.so~ from C
- [[file:troubleshooting.org][Troubleshooting]] - ~module not found~ and empty clouds
